    ...
    echo '
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="?delete-id=' . $row['id'] . '&token=' . $csrf_token . '" class="btn btn-danger btn-sm" onclick="return confirm(\'Êtes-vous sûr de vouloir supprimer ce fichier ?\');"><i class="fa fa-trash"></i> Delete</a>
                        </td>
                    </tr>
';
}
